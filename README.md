...
|-------------------------|----------------------------------------------------------|
| `main`                  | [View Deployment](https://your-amplify-link.com/main](https://main.dxxmujgcp190n.amplifyapp.com/))    |
| `test-keyboard`         | [View Deployment](https://your-amplify-link.com/test-keyboard](https://feature.dxxmujgcp190n.amplifyapp.com/)) |
| `test-form`             | [View Deployment](https://your-amplify-link.com/test-form](https://berucha.dxxmujgcp190n.amplifyapp.com/)) |
